...
class Game {
  constructor(p1, p2, color1 = "red", color2 = "blue", WIDTH = 7, HEIGHT = 6) {
    this.WIDTH = WIDTH;
    this.HEIGHT = HEIGHT;
  ...
  placeInTable(y, x) {
    ...
    piece.style.backgroundColor = this.currColor;
  ...
  handleClick(evt) {
    ...
    this.currColor =
      this.currColor === this.color[0] ? this.color[1] : this.color[0];
  }
...
gameStart.addEventListener("submit", function (e) {
  e.preventDefault();
